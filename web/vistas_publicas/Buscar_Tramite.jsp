        ...
        <div id="wrapper">
            <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
                <div id="noimp" class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../vistas_publicas/Buscar_Tramite.jsp"><img src="../img/logoing.png" class="img-responsive" id="logo"/><b class="titulo">Facultad de Ingenieria y Arquitectura</b></a> 
                </div>
            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div id="noimp" class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <!--
                        <li>
                            <a  href="../vistas_publicas/Buscar_Tramite.jsp"><i class="fa fa-dashboard fa-3x"></i>busqueda de proceso</a>
                        </li>
                        -->
                    </ul>
                </div>
